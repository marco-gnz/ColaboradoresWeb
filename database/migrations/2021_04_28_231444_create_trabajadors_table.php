...
class CreateTrabajadorsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('trabajadors', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_comuna')->unsigned();
            ...
            $table->unsignedBigInteger('id_previcion_salud')->unsigned()->nullable();
            $table->foreign('id_previcion_salud')->references('id')->on('prevision_saluds');
            $table->unsignedBigInteger('id_afp')->unsigned()->nullable();
            $table->foreign('id_afp')->references('id')->on('afps');
            $table->unsignedBigInteger('id_tipo_pago')->unsigned()->nullable();
            $table->foreign('id_tipo_pago')->references('id')->on('tipo_pagos');
            $table->unsignedBigInteger('id_users')->unsigned()->nullable();
